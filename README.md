...
# 🎮 Capote — Community Edition

**A story-driven indie adventure, fully self-contained.**
...
Capote is a narrative-driven indie adventure that follows a solitary journey through hand-drawn environments, blending environmental puzzles with a story-focused progression. This Community Edition is a standalone build distributed as a self-contained package. It includes all content of the base game and is ready to play immediately, with no storefront or additional software required.

Players who want an offline, self-contained single-player adventure they can run locally on any modern Windows PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3345950/9c252cc6d14cb4d8bb33b6189fd5e977b8608977/ss_9c252cc6d14cb4d8bb33b6189fd5e977b8608977.1920x1080.jpg?t=1788362661" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3345950/375e178539d4561f528147b4f23ab19a8a14e7ca/ss_375e178539d4561f528147b4f23ab19a8a14e7ca.1920x1080.jpg?t=1788362661" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3345950/ef738675b8176d9d32cb37914dbbabfbd17c0450/ss_ef738675b8176d9d32cb37914dbbabfbd17c0450.1920x1080.jpg?t=1788362661" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, Spanish, French, German, Portuguese-Brazil, Russian
...
- 📖 **Story-Driven Narrative** — A carefully paced single-player story told through exploration and dialogue.
- 🎨 **Hand-Drawn Art Style** — Fully hand-drawn visuals with a distinctive, atmospheric art direction.
- 🧩 **Environmental Puzzles** — Puzzle-solving integrated into the world and its progression.
- 🌙 **Atmospheric Soundtrack** — An original score that adapts to the tone of each scene.
- 📦 **Self-Contained Package** — Everything ships in one folder — no storefront required.
- ⚡ **Ready to Play** — Launch the executable and start playing immediately.
- 💾 **All Content Included** — The build includes all base-game content in a single release.
- 🌍 **Multiple Languages** — Interface localization in several languages.
- 🪟 **Windows Native** — Built and verified for Windows 10 and Windows 11.
...
| **Processor** | Intel Core i3-4130 or AMD equivalent | Intel Core i5-8400 or AMD Ryzen 5 2600 |
| **RAM** | 4 GB | 8 GB |
| **Graphics** | Intel HD 4000 / GeForce GTX 650 | GeForce GTX 960 / Radeon R9 380 |
| **Storage** | 4 GB available space | 6 GB available space |
| **Additional** | DirectX 11, keyboard and mouse | Gamepad supported, headphones recommended |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Capote\Saved`
